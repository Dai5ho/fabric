...
def sync_dbx_uc_tables_to_onelake(databricks_config, fabric_config):
    ...
    deletions_required = [name for name in uc_shortcuts if name in uc_table_names] #[name for name in uc_shortcuts if name not in uc_table_names]
    creations_required = [name for name in uc_table_names if name in uc_shortcuts] #[name for name in uc_table_names if name not in uc_shortcuts]
